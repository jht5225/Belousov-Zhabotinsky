...
STATIC_VAR int num_deltas_fe2_reaction = 2;
STATIC_VAR int deltas_fe2_reaction[] = {-1, 1/*, 4*/};
STATIC_VAR specie_id delta_ids_fe2_reaction[] = {FE2,FE3/*, HBRO*/};

STATIC_VAR int num_deltas_fe3_reaction = 3;
STATIC_VAR int deltas_fe3_reaction[] = {-3 /*,-1*/, 4,2};
STATIC_VAR specie_id delta_ids_fe3_reaction[] = {FE3/*,HBRO*/,FE2,BR};
...
STATIC_VAR int deltas_fe2_synthesis[] = {1};
